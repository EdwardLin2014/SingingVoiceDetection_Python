...
for t in np.arange(numMusics):
    ...
    tic = time.time()
    if t < 137:
        AD.audiowrite(AudioOutDirStr+'/IBM_iSTFT_2048_2048_512/'+str(t+1)+'_Voice_'+WavFileNames[t][-15:], Voice.IBMy, fs );
        AD.audiowrite(AudioOutDirStr+'/IBM_iSTFT_2048_2048_512/'+str(t+1)+'_Song_'+WavFileNames[t][-15:], Song.IBMy, fs );
        AD.audiowrite(AudioOutDirStr+'/IBMPeak_iSTFT_2048_2048_512/'+str(t+1)+'_Voice_'+WavFileNames[t][-15:], Voice.IBMPeaky, fs );
        AD.audiowrite(AudioOutDirStr+'/IBMPeak_iSTFT_2048_2048_512/'+str(t+1)+'_Song_'+WavFileNames[t][-15:], Song.IBMPeaky, fs );
        AD.audiowrite(AudioOutDirStr+'/IBMPeak_AS_2048_2048_512/'+str(t+1)+'_Voice_'+WavFileNames[t][-15:], Voice.IBMPeakSiney, fs );
        AD.audiowrite(AudioOutDirStr+'/IBMPeak_AS_2048_2048_512/'+str(t+1)+'_Song_'+WavFileNames[t][-15:], Song.IBMPeakSiney, fs );
    else:
        AD.audiowrite(AudioOutDirStr+'/IBM_iSTFT_2048_2048_512/'+str(t+1)+'_Voice_'+WavFileNames[t][-16:], Voice.IBMy, fs );
        AD.audiowrite(AudioOutDirStr+'/IBM_iSTFT_2048_2048_512/'+str(t+1)+'_Song_'+WavFileNames[t][-16:], Song.IBMy, fs );
        AD.audiowrite(AudioOutDirStr+'/IBMPeak_iSTFT_2048_2048_512/'+str(t+1)+'_Voice_'+WavFileNames[t][-16:], Voice.IBMPeaky, fs );
        AD.audiowrite(AudioOutDirStr+'/IBMPeak_iSTFT_2048_2048_512/'+str(t+1)+'_Song_'+WavFileNames[t][-16:], Song.IBMPeaky, fs );    
        AD.audiowrite(AudioOutDirStr+'/IBMPeak_AS_2048_2048_512/'+str(t+1)+'_Voice_'+WavFileNames[t][-16:], Voice.IBMPeakSiney, fs );
        AD.audiowrite(AudioOutDirStr+'/IBMPeak_AS_2048_2048_512/'+str(t+1)+'_Song_'+WavFileNames[t][-16:], Song.IBMPeakSiney, fs );
    toc = time.time() - tic
